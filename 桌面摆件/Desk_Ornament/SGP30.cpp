...
u8_t SGP::I2C_Write_Byte(u8_t Write_Byte) // Sendbyte
{
  u8_t i;
  pinMode(SDA, OUTPUT);
  SCL_0;
...
u8_t SGP::I2C_Read_Byte(u8_t AckValue) // receivebyte
{
  u8_t i, RDByte = 0;
  pinMode(SDA, OUTPUT);
...
void SGP::SGP30_Write(u8_t a, u8_t b)
{
  I2CStart();
